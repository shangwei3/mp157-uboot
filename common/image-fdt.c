...
int boot_relocate_fdt(struct lmb *lmb, char **of_flat_tree, ulong *of_size)
{
	...
	fdt_setprop_u32(fdt_blob, nodeoffset, "select_id", atk_lcd_id);

    switch(atk_lcd_id) {
    case 1:
    case 2:
		nodeoffset = fdt_node_offset_by_compatible(fdt_blob, 0 ,"goodix,gt9147");
		if (nodeoffset < 0)
		{
			printf("couldn't find gt9147\n");
            break;
		}
		fdt_del_node(fdt_blob,nodeoffset);
        break;
    case 0:
    case 4:
    case 5:
		nodeoffset = fdt_node_offset_by_compatible(fdt_blob, 0 ,"edt,edt-ft5206");
		if (nodeoffset < 0)
		{
			printf("couldn't find ft5206\n");
            break;
		}
		fdt_del_node(fdt_blob,nodeoffset);
        break;
